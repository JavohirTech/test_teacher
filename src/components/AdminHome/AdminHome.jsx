        ...
        <div className="admin_home_stats">
          <div className="admin_stats_card">
            <h4 className="d-flex align-items-center">
              {" "}
              <i className="fa-solid fa-users fa-2x p-3 m-3"></i> Foydalanuvchi:{" "}
              {stats.data.all_users}
            </h4>
          </div>
          <div className="admin_stats_card">
            <h4 className="d-flex align-items-center">
          ...
          <div className="admin_stats_card">
            <h4 className="d-flex align-items-center">
              {" "}
              <i className="fa-regular fa-shield-check fa-2x p-3 m-3"></i>Ruxsat
              berilgan: {stats.data.aproved_users}
            </h4>
          </div>
          <div className="admin_stats_card">
            <h4 className="d-flex align-items-center">
              {" "}
              <i className="fa-regular fa-user-minus fa-2x p-3 m-3"></i>Ruxsat
              berilmagan: {stats.data.not_aproved_users}
            </h4>
          </div>
        </div>
        <AdminTeachers />
